 ...
 * @author Jeff Gilfelt
 */
public class GFBadgeView extends TextView {
    ...
    public GFBadgeView(Context context) {
        this(context, (AttributeSet) null, android.R.attr.textViewStyle);
    }

    public GFBadgeView(Context context, AttributeSet attrs) {
     ...
     */
    public GFBadgeView(Context context, View target) {
     ...
     */
    public GFBadgeView(Context context, TabWidget target, int index) {
        this(context, null, android.R.attr.textViewStyle, target, index);
    }

    public GFBadgeView(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs, defStyle, null, 0);
    }

    public GFBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
