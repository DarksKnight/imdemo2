 ...
 */
public class GFHeaderAndFooterRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public GFHeaderAndFooterRecyclerViewAdapter() {
    }

    public GFHeaderAndFooterRecyclerViewAdapter(RecyclerView.Adapter innerAdapter) {
