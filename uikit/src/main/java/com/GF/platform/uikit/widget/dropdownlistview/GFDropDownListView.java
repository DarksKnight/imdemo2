...
public class GFDropDownListView extends ListView implements OnScrollListener {
    ...
    public GFDropDownListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
...
//		addHeaderView(headView, null, false);
    ...
    public void enableMove(boolean flag) {
        isRefreshableHeader = flag;
    }
}
