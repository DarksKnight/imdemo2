 ...
 * 滑动显示对应功能
 */
public class GFSwipeLayout extends FrameLayout {
    ...
    public GFSwipeLayout(Context context) {
        this(context, null);
    }

    public GFSwipeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GFSwipeLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mDragHelper = ViewDragHelper.create(this, mDragHelperCallback);
        mTouchSlop = ViewConfiguration.get(context).getScaledTouchSlop();

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.GFSwipeLayout);
        int dragEdgeChoices = a.getInt(R.styleable.GFSwipeLayout_drag_edge, DRAG_RIGHT);
        mEdgeSwipesOffset[DragEdge.Left.ordinal()] = a.getDimension(R.styleable.GFSwipeLayout_leftEdgeSwipeOffset, 0);
        mEdgeSwipesOffset[DragEdge.Right.ordinal()] = a.getDimension(R.styleable.GFSwipeLayout_rightEdgeSwipeOffset, 0);
        mEdgeSwipesOffset[DragEdge.Top.ordinal()] = a.getDimension(R.styleable.GFSwipeLayout_topEdgeSwipeOffset, 0);
        mEdgeSwipesOffset[DragEdge.Bottom.ordinal()] = a.getDimension(R.styleable.GFSwipeLayout_bottomEdgeSwipeOffset, 0);
        setClickToClose(a.getBoolean(R.styleable.GFSwipeLayout_clickToClose, mClickToClose));
        ...
        int ordinal = a.getInt(R.styleable.GFSwipeLayout_show_mode, ShowMode.PullOut.ordinal());
    ...
    public interface SwipeListener {
        void onStartOpen(GFSwipeLayout layout);

        void onOpen(GFSwipeLayout layout);

        void onStartClose(GFSwipeLayout layout);

        void onClose(GFSwipeLayout layout);

        void onUpdate(GFSwipeLayout layout, int leftOffset, int topOffset);

        void onHandRelease(GFSwipeLayout layout, float xvel, float yvel);
    }
    ...
    private ViewDragHelper.Callback mDragHelperCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            for (SwipeListener l : mSwipeListeners) {
                l.onHandRelease(GFSwipeLayout.this, xvel, yvel);
            }
    ...
    protected void dispatchSwipeEvent(int surfaceLeft, int surfaceTop, boolean open) {
        ...
        if (!mSwipeListeners.isEmpty()) {
            ...
            for (SwipeListener l : mSwipeListeners) {
                ...
                l.onUpdate(GFSwipeLayout.this, surfaceLeft - getPaddingLeft(), surfaceTop - getPaddingTop());
            }

            if (status == Status.Close) {
                for (SwipeListener l : mSwipeListeners) {
                    l.onClose(GFSwipeLayout.this);
                }
                mEventCounter = 0;
            }
    ...
    private void performAdapterViewItemClick() {
        ...
        if (t instanceof AdapterView) {
            ...
            int p = view.getPositionForView(GFSwipeLayout.this);
    ...
    private boolean performAdapterViewItemLongClick() {
        ...
        if (t instanceof AdapterView) {
            ...
            try {
                ...
                handled = (boolean) m.invoke(view, GFSwipeLayout.this, p, vId);

            } catch (Exception e) {
                e.printStackTrace();

                if (view.getOnItemLongClickListener() != null) {
                    handled = view.getOnItemLongClickListener().onItemLongClick(view, GFSwipeLayout.this, p, vId);
                }
                if (handled) {
