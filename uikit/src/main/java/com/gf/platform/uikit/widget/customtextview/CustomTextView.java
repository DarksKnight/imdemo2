    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (a != null) {
            ...
            for (int i = 0; i < count; i++) {
                index = a.getIndex(i);
                if (index == R.styleable.CustomTextView_bottom_height) {
                    bottomHeight = a.getDimensionPixelSize(index, -1);
                } else if (index == R.styleable.CustomTextView_bottom_width) {
                    bottomWidth = a.getDimensionPixelSize(index, -1);
                } else if (index == R.styleable.CustomTextView_left_height) {
                    leftHeight = a.getDimensionPixelSize(index, -1);
                } else if (index == R.styleable.CustomTextView_left_width) {
                    leftWidth = a.getDimensionPixelSize(index, -1);
                }else if (index == R.styleable.CustomTextView_right_height) {
                    rightHeight = a.getDimensionPixelSize(index, -1);
                }else if (index == R.styleable.CustomTextView_right_width) {
                    rightWidth = a.getDimensionPixelSize(index, -1);
                }else if (index == R.styleable.CustomTextView_top_height) {
                    topHeight = a.getDimensionPixelSize(index, -1);
                }else if (index == R.styleable.CustomTextView_top_width) {
