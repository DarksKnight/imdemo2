...
public class ParseDataUtil {
    ...
    public static List<EmoticonEntity> parseEmoticons(String name) {
        ...
        try {
            String json = KeyBoardUtil.getFileFromSD(Environment.getExternalStorageDirectory() + File.separator + KeyBoardUtil.FOLDERNAME + File.separator + name + File.separator + name + ".json");
