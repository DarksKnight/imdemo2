...
import com.gf.platform.gfplatform.base.CommonAdapter;
import com.gf.platform.gfplatform.util.ViewHolder;
...
public class EmoticonsAdapter extends CommonAdapter<EmoticonEntity> {
    ...
    @Override
    public void convert(ViewHolder viewHolder, EmoticonEntity entity) {
        RelativeLayout lyRoot = viewHolder.getView(R.id.ly_root);
        SimpleDraweeView ivEmoticon = viewHolder.getView(R.id.iv_emoticon);
