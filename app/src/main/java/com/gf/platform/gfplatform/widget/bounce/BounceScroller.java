...
public class BounceScroller extends RelativeLayout {
    public static final String TAG = BounceScroller.class.getSimpleName();

    public static final int DEFALUT_DURATION = 400;

    public SwipeItemMangerImpl mItemManger = null;
    ...
    public void setItemManager(SwipeItemMangerImpl itemManager) {
        mItemManger = itemManager;
    }
}
